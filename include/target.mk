...
# config file list used for compiling for targets using defconfigs
LINUX_KCONFIG_LIST2 = $(wildcard $(LINUX_DEFCONFIG) $(LINUX_TARGET_CONFIG) $(LINUX_SUBTARGET_CONFIG) $(TOPDIR)/env/kernel-config)
